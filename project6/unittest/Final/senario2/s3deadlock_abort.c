...
find_thread_func(void* arg)
{
    ...
    printf("find thread id : %d, trx id : %d, result : %s // succ\n",id, trid, val);
...
//total 3 update, total 8 log
    // sprintf(val,"%d",-1);
    // int ret = db_update(1,1, val, trid);
    // print_tree(1);
    // print_buff();
    
    // sprintf(val,"%d",-2);
    // ret = db_update(1,2, val, trid);
    // print_tree(1);
    // print_buff();
    
//tatal 2 update. total 6 log 
    sprintf(val,"%d",-2);
...
int main(int argc, char ** argv){
    ...
    // printf("IN main, trx_begin : %d\n",tmp_id);
    // for(int i =0; i<INSERT_NUM; i++){
    //     key = i;
    //     sprintf(value,"%d",i);
    //     // printf("IN main, i : %d\n",i);
    //     ret = db_insert(table_id, key, value);
    //     // printf("IN main, i : %d, ret : %d\n",i,ret);
    //     // print_tree(1);
    // }
    // print_tree(1);
    // tmp_id = trx_commit(1);
    // printf("IN main, trx_commit : %d\n",tmp_id);
    // exit(1);
